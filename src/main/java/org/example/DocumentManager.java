...
public class DocumentManager {
    ...
    /**
     * Checks if a given document matches the criteria specified in the search request.
     *
     * @param doc the document to be checked
     * @param request the search request containing the criteria to be matched
     * @return true if the document matches all the criteria specified in the search request, false otherwise
     */
